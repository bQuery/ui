...
const meta: Meta = {
  ...
  tags: ['autodocs'],
  render: (args) => html`<bq-chip variant=${args.variant} size=${args.size} ?removable=${args.removable} ?selected=${args.selected} ?disabled=${args.disabled}>${args.label}</bq-chip>`,
  argTypes: {
